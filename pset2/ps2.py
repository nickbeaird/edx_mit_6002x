...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.width = width
        self.height = height
        self.room_dimensions = width * height
        self.clean_tiles = []
    ...
    def getNumTiles(self):
        ...
        returns: an integer
        """
        return int(self.room_dimensions / 1)
...
if __name__ == "__main__":
    rm = RectangularRoom(3, 5)
    rm.cleanTileAtPosition(Position(0.6, 0.3))
    print(rm.isTileCleaned(0, 0))
    print("Number of clean tiles: ", rm.getNumCleanedTiles())
    rm.cleanTileAtPosition(Position(0.6, 0.3))
    print(rm.isTileCleaned(0, 0))
    print("Number of clean tiles: ", rm.getNumCleanedTiles())
    rm.cleanTileAtPosition(Position(1.6, 3.3))
    print(rm.isTileCleaned(1, 3))
    print("Number of clean tiles: ", rm.getNumCleanedTiles())

    print(rm.isPositionInRoom(Position(0.00, 0.00)))
